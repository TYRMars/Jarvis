...
export const SEARCH_ENTRIES: SearchEntry[] = [
  ...
  },
  {
    ...
    groupKey: "settingsNavGroupCapabilities",
    groupFallback: "Capabilities",
    primaryKey: "settingsNavRouting",
    primaryFallback: "Routing",
    tokens: [
      "routing", "路由",
      "fallback", "fallback chain", "备用链", "备用模型",
      "route slot", "槽位",
      "coding", "编码",
      "review", "评审",
      "summarization", "总结",
  ...
  },
  {
    ...
    groupKey: "settingsNavGroupCapabilities",
    groupFallback: "Capabilities",
    primaryKey: "settingsNavSubagents",
    ...
    tokens: [
      ...
      "preset", "preset agent",
      "specialist", "专家",
      "claude_code", "codex", "read_doc", "review",
      "built-in subagents", "内置子智能体",
    ],
  },
  {
    ...
    tokens: ["extensions", "扩展", "connectors", "连接器", "composio"],
  },
  {
    sectionId: "extensions",
    tabId: "connectors",
    ...
    primaryKey: "settingsTabConnectors",
    primaryFallback: "Connectors",
    tokens: [
      "connectors", "连接器",
      "composio", "composio api key", "composio mcp",
      "mcp url", "server id", "user id",
      "gmail", "slack", "notion", "linear", "github",
