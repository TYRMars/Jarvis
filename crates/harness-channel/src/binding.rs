...
//!
//! Records the persistent mapping between a chat on an external
//! messaging platform (Feishu / Lark, DingTalk, WeCom, Telegram, …)
//! and a Jarvis `Conversation`. The lookup that lets a channel
//! adapter answer *"this user just spoke in WeCom group `wm…ABCD` —
//! which Jarvis conversation should I drop their message into?"*
//! without losing memory across adapter reconnects.
//!
...
impl ChannelBinding {
    ...
    /// `harness_project::ProjectMemory::touch`.
