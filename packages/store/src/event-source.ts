 ...
 * after commit" ordering. A listener that throws is isolated (log-free
 * swallow) so it neither rejects the already-committed mutation nor starves
 * the listeners registered after it — the mirror of broadcast's per-receiver
 * isolation.
 */
